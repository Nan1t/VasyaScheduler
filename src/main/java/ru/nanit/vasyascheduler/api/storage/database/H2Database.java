...
public class H2Database implements Database {
    ...
    public H2Database(Path dir, String dbname, String user, String password) {
        connString = "jdbc:h2:" + dir + File.separator + dbname;
        pool = JdbcConnectionPool.create(connString, user, password);
        Logger.info("H2 connection pool created");
    }
